...
// SysProvincesDao is the data access object for table gc_sys_provinces.
...
// SysProvincesColumns defines and stores column names for table gc_sys_provinces.
...
// sysProvincesColumns holds the columns for table gc_sys_provinces.
