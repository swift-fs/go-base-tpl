...
// PayRefundDao is the data access object for table gc_pay_refund.
...
// PayRefundColumns defines and stores column names for table gc_pay_refund.
...
// payRefundColumns holds the columns for table gc_pay_refund.
