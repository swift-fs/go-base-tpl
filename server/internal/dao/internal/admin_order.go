...
// AdminOrderDao is the data access object for table gc_admin_order.
...
// AdminOrderColumns defines and stores column names for table gc_admin_order.
...
// adminOrderColumns holds the columns for table gc_admin_order.
