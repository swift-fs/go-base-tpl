...
// SysAttachmentColumns defines and stores column names for table gc_sys_attachment.
...
// sysAttachmentColumns holds the columns for table gc_sys_attachment.
