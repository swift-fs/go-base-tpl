...
// SysLogDao is the data access object for table gc_sys_log.
...
// SysLogColumns defines and stores column names for table gc_sys_log.
...
// sysLogColumns holds the columns for table gc_sys_log.
