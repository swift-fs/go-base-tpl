...
// SysBlacklistDao is the data access object for table gc_sys_blacklist.
...
// SysBlacklistColumns defines and stores column names for table gc_sys_blacklist.
...
// sysBlacklistColumns holds the columns for table gc_sys_blacklist.
