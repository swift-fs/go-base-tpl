...
// SysDictTypeDao is the data access object for table gc_sys_dict_type.
...
// SysDictTypeColumns defines and stores column names for table gc_sys_dict_type.
...
// sysDictTypeColumns holds the columns for table gc_sys_dict_type.
