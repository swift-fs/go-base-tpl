...
// AddonHgexampleTableColumns defines and stores column names for table gc_addon_hgexample_table.
...
// addonHgexampleTableColumns holds the columns for table gc_addon_hgexample_table.
...
func NewAddonHgexampleTableDao() *AddonHgexampleTableDao {
	return &AddonHgexampleTableDao{
		group:   "default",
		table:   "gc_addon_hgexample_table",
