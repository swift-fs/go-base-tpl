...
// SysConfigDao is the data access object for table gc_sys_config.
...
// SysConfigColumns defines and stores column names for table gc_sys_config.
...
// sysConfigColumns holds the columns for table gc_sys_config.
