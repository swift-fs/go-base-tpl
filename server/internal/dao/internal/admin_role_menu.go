...
// AdminRoleMenuDao is the data access object for table gc_admin_role_menu.
...
// AdminRoleMenuColumns defines and stores column names for table gc_admin_role_menu.
type AdminRoleMenuColumns struct {
	RoleId string // 角色ID
	MenuId string // 菜单ID
}

// adminRoleMenuColumns holds the columns for table gc_admin_role_menu.
