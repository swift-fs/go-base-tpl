...
// SysAddonsConfigDao is the data access object for table gc_sys_addons_config.
...
// SysAddonsConfigColumns defines and stores column names for table gc_sys_addons_config.
...
// sysAddonsConfigColumns holds the columns for table gc_sys_addons_config.
