...
// AdminMemberPostDao is the data access object for table gc_admin_member_post.
...
// AdminMemberPostColumns defines and stores column names for table gc_admin_member_post.
type AdminMemberPostColumns struct {
	MemberId string // 管理员ID
	PostId   string // 岗位ID
}

// adminMemberPostColumns holds the columns for table gc_admin_member_post.
