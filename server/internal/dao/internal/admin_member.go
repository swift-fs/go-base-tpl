...
// AdminMemberDao is the data access object for table gc_admin_member.
...
// AdminMemberColumns defines and stores column names for table gc_admin_member.
...
// adminMemberColumns holds the columns for table gc_admin_member.
